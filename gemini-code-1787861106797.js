...
function translateText(language) {
    ...
    const pageTitles = {
        'Main-v2.html': ['AURA ENTERPRISE FZE LLC | الموقع الرسمي', 'AURA ENTERPRISE FZE LLC | Official Website'],
    ...
    const currentPage = window.location.pathname.split('/').pop() || 'Main-v2.html';
